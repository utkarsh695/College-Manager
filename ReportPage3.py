...
class Report3Class:
    def __init__(self,hwindow):
        ...
        self.hdlbl = Label(self.window,text='Student Report By DOB',background=mycolor2,font=('Cambria',20,'bold'))


        self.L1 = Label(self.window,text='From',background=mycolor1,font=myfont1)
        self.L2 = Label(self.window,text='To',background=mycolor1,font=myfont1)
        ...
        self.b2 = Button(self.window,text='Search',font=myfont1,background=mycolor2,command=self.showAllData)
        ...
        self.t2.place(x=x1+350,y=y1)
        self.b2.place(x=x1+500,y=y1,height=40)
        y1+=y_diff
