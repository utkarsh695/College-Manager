...
class ChangePasswordClass:
    def __init__(self,hwindow,uname):
        ...
        self.hdlbl = Label(self.window,text='Change Password',background=mycolor2,font=('Cambria',20,'bold'))
        ...
        #----------------- buttons ---------------------
        self.b1 = Button(self.window,text='Change',font=myfont1,background=mycolor2,command=self.updateData)
