...
class LoginClass:
    def __init__(self):
        self.window = Tk()
        self.window.title("My College Manager\Login")
        ...
        #----------------- buttons ---------------------
        self.b1 = Button(self.window,text='Login',font=myfont1,background=mycolor2,command=self.checkData)
        self.b2 = Button(self.window,text='Try another way',font=myfont1,background=mycolor2 )
